...
namespace Authorize.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class SyslogactionEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("SyslogactionEntity", InheritanceHierarchyType.None, false, (int)Authorize.Dal.EntityType.SyslogactionEntity, typeof(SyslogactionEntity), typeof(SyslogactionEntityFactory), false);
			}
		}
		...
		public SyslogactionEntity(System.String id) : this(id, null)
		{
		}
		...
		/// <param name="id">PK value for Syslogaction which data should be fetched into this Syslogaction object</param>
		/// <param name="validator">The custom validator object for this SyslogactionEntity</param>
		public SyslogactionEntity(System.String id, IValidator validator)
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		/// <remarks>Mapped on  table field: "syslogaction"."id".<br/>Table field type characteristics (type, precision, scale, length): Text, 0, 0, 1073741824.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.String Id
		{
			get { return (System.String)GetValue((int)SyslogactionFieldIndex.Id, true); }
