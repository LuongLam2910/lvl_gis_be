...
namespace Authorize.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class SystaomaEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("SystaomaEntity", InheritanceHierarchyType.None, false, (int)Authorize.Dal.EntityType.SystaomaEntity, typeof(SystaomaEntity), typeof(SystaomaEntityFactory), false);
			}
		}
