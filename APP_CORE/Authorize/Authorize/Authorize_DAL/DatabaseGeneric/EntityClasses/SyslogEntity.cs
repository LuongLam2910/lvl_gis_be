...
namespace Authorize.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class SyslogEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("SyslogEntity", InheritanceHierarchyType.None, false, (int)Authorize.Dal.EntityType.SyslogEntity, typeof(SyslogEntity), typeof(SyslogEntityFactory), false);
			}
		}
