...
namespace App.QTHTGis.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class SystudienEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("SystudienEntity", InheritanceHierarchyType.None, false, (int)App.QTHTGis.Dal.EntityType.SystudienEntity, typeof(SystudienEntity), typeof(SystudienEntityFactory), false);
			}
		}
