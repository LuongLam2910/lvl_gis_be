...
namespace App.QTHTGis.Dal.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class DmtochucEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("DmtochucEntity", InheritanceHierarchyType.None, false, (int)App.QTHTGis.Dal.EntityType.DmtochucEntity, typeof(DmtochucEntity), typeof(DmtochucEntityFactory), false);
				AddNavigatorMetaData<DmtochucEntity, EntityCollection<SysunitEntity>>("Sysunits", a => a._sysunits, (a, b) => a._sysunits = b, a => a.Sysunits, () => new DmtochucRelations().SysunitEntityUsingIdTochuc, typeof(SysunitEntity), (int)App.QTHTGis.Dal.EntityType.SysunitEntity);
				AddNavigatorMetaData<DmtochucEntity, EntityCollection<TochucChucvuEntity>>("TochucChucvus", a => a._tochucChucvus, (a, b) => a._tochucChucvus = b, a => a.TochucChucvus, () => new DmtochucRelations().TochucChucvuEntityUsingIdTochuc, typeof(TochucChucvuEntity), (int)App.QTHTGis.Dal.EntityType.TochucChucvuEntity);
			}
		}
