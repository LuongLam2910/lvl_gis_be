...
//
// The Initial Developer of this Original Code is Ted Dunsford. Created 8/13/2009 4:45:01 PM
//
...
namespace App.CongAnGis.Services.Business.ConverterProj.Transforms
{
    ...
    /// </summary>
    public class McBrydeThomasFlatPolarSine : QuarticAuthalic
    {
        #region Constructors
        ...
        /// </summary>
        public McBrydeThomasFlatPolarSine()
        {
            Proj4Name = "mbt_s";
            Name = "McBryde_Thomas_Flat_Polar_Sine";
        }
