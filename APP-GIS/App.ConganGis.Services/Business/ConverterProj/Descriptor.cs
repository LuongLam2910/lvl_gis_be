...
using App.CongAnGis.Services.Business.ConverterProj.Reflection;
...
namespace App.CongAnGis.Services.Business.ConverterProj
{
    ...
    public class ProjDescriptor : ProjCopyBase, IProjDescriptor
    {
        ...
        /// <returns></returns>
        public bool Matches(IProjMatchable other, out List<string> mismatchedProperties)
        {
