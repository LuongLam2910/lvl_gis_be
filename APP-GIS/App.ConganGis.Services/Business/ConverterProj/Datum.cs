...
namespace App.CongAnGis.Services.Business.ConverterProj
{
    ...
    public class Datum : ProjDescriptor, IEsriString
    {
        ...
        public void ParseEsriString(string esriString)
        {
            ...
            Stream datumStream = File.Exists(fileName) ? File.Open(fileName, FileMode.Open) : a.GetManifestResourceStream("App.Gis.Services.Business.ConverterProj.XML.datums.xml");
