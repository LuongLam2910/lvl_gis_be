...
namespace App.CongAnGis.Services.Business.ConverterProj.GeographicCategories
{
    ...
    public class Africa : CoordinateSystemCategory
    {
        ...
        public Africa()
        {
            ...
            Abidjan1987.IsLatLon = true;
            Accra.IsLatLon = true;
            Adindan.IsLatLon = true;
            Afgooye.IsLatLon = true;
            Agadez.IsLatLon = true;
            AinelAbd1970.IsLatLon = true;
            Arc1950.IsLatLon = true;
            Arc1960.IsLatLon = true;
            AyabelleLighthouse.IsLatLon = true;
            Beduaram.IsLatLon = true;
            Bissau.IsLatLon = true;
            Camacupa.IsLatLon = true;
            Cape.IsLatLon = true;
            Carthage.IsLatLon = true;
            Carthagedegrees.IsLatLon = true;
            CarthageParis.IsLatLon = true;
            Conakry1905.IsLatLon = true;
            CotedIvoire.IsLatLon = true;
            Dabola.IsLatLon = true;
            Douala.IsLatLon = true;
            Douala1948.IsLatLon = true;
            Egypt1907.IsLatLon = true;
            Egypt1930.IsLatLon = true;
            EuropeanDatum1950.IsLatLon = true;
            EuropeanLibyanDatum1979.IsLatLon = true;
            Garoua.IsLatLon = true;
            Hartebeesthoek1994.IsLatLon = true;
            Kousseri.IsLatLon = true;
            KuwaitOilCompany.IsLatLon = true;
            KuwaitUtility.IsLatLon = true;
            Leigon.IsLatLon = true;
            Liberia1964.IsLatLon = true;
            Locodjo1965.IsLatLon = true;
            Lome.IsLatLon = true;
            Madzansua.IsLatLon = true;
            Mahe1971.IsLatLon = true;
            Malongo1987.IsLatLon = true;
            Manoca.IsLatLon = true;
            Manoca1962.IsLatLon = true;
            Massawa.IsLatLon = true;
            Merchich.IsLatLon = true;
            Merchichdegrees.IsLatLon = true;
            Mhast.IsLatLon = true;
            Minna.IsLatLon = true;
            Moznet.IsLatLon = true;
            Mporaloko.IsLatLon = true;
            Nahrwan1967.IsLatLon = true;
            NationalGeodeticNetworkKuwait.IsLatLon = true;
            NordSahara1959.IsLatLon = true;
            NordSahara1959Paris.IsLatLon = true;
            Observatario.IsLatLon = true;
            Oman.IsLatLon = true;
            Palestine1923.IsLatLon = true;
            PDO1993.IsLatLon = true;
            Point58.IsLatLon = true;
            PointeNoire.IsLatLon = true;
            Qatar.IsLatLon = true;
            Qatar1948.IsLatLon = true;
            Schwarzeck.IsLatLon = true;
            SierraLeone1924.IsLatLon = true;
            SierraLeone1960.IsLatLon = true;
            SierraLeone1968.IsLatLon = true;
            SouthYemen.IsLatLon = true;
            Sudan.IsLatLon = true;
            Tananarive1925.IsLatLon = true;
            Tananarive1925Paris.IsLatLon = true;
            Tete.IsLatLon = true;
            TrucialCoast1948.IsLatLon = true;
            Voirol1875.IsLatLon = true;
            Voirol1875degrees.IsLatLon = true;
            Voirol1875Paris.IsLatLon = true;
            VoirolUnifie1960.IsLatLon = true;
            VoirolUnifie1960degrees.IsLatLon = true;
            VoirolUnifie1960Paris.IsLatLon = true;
            YemenNGN1996.IsLatLon = true;
            Yoff.IsLatLon = true;
