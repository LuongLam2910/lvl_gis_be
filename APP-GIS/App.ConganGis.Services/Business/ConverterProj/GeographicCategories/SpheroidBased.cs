...
namespace App.CongAnGis.Services.Business.ConverterProj.GeographicCategories
{
    ...
    public class SpheroidBased : CoordinateSystemCategory
    {
        ...
        public SpheroidBased()
        {
            ...
            Airy1830.IsLatLon = true;
            Airymodified.IsLatLon = true;
            AustralianNational.IsLatLon = true;
            Authalicsphere.IsLatLon = true;
            AuthalicsphereARCINFO.IsLatLon = true;
            AverageTerrestrialSystem1977.IsLatLon = true;
            Bessel1841.IsLatLon = true;
            Besselmodified.IsLatLon = true;
            BesselNamibia.IsLatLon = true;
            Clarke1858.IsLatLon = true;
            Clarke1866.IsLatLon = true;
            Clarke1866Michigan.IsLatLon = true;
            Clarke1880.IsLatLon = true;
            Clarke1880Arc.IsLatLon = true;
            Clarke1880Benoit.IsLatLon = true;
            Clarke1880IGN.IsLatLon = true;
            Clarke1880RGS.IsLatLon = true;
            Clarke1880SGA.IsLatLon = true;
            Everestdefinition1967.IsLatLon = true;
            Everestdefinition1975.IsLatLon = true;
            Everest1830.IsLatLon = true;
            Everestmodified.IsLatLon = true;
            Everestmodified1969.IsLatLon = true;
            Fischer1960.IsLatLon = true;
            Fischer1968.IsLatLon = true;
            Fischermodified.IsLatLon = true;
            GRS1967.IsLatLon = true;
            GRS1980.IsLatLon = true;
            Helmert1906.IsLatLon = true;
            Hough1960.IsLatLon = true;
            IndonesianNational.IsLatLon = true;
            International1924.IsLatLon = true;
            International1967.IsLatLon = true;
            Krasovsky1940.IsLatLon = true;
            OSU1986geoidalmodel.IsLatLon = true;
            OSU1991geoidalmodel.IsLatLon = true;
            Plessis1817.IsLatLon = true;
            SphereEMEP.IsLatLon = true;
            Struve1860.IsLatLon = true;
            Transitpreciseephemeris.IsLatLon = true;
            Walbeck.IsLatLon = true;
            WarOffice.IsLatLon = true;
            WGS1966.IsLatLon = true;
